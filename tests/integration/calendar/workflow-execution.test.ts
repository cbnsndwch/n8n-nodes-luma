...
describe('Calendar Workflow Execution Tests', () => {
    ...
    describe('Calendar Operation Execution', () => {
        it('should handle calendar list events operation', async () => {
            ...
            // Verify parameters
            expect(mockExecuteFunctions.getNodeParameter('resource')).toBe('calendar');
            expect(mockExecuteFunctions.getNodeParameter('operation')).toBe('listEvents');
            expect(mockExecuteFunctions.getNodeParameter('calendarId')).toBe('calendar-123');
        });
        ...
        it('should handle calendar lookup event operation', async () => {
            ...
            // Verify parameters
            expect(mockExecuteFunctions.getNodeParameter('resource')).toBe('calendar');
            expect(mockExecuteFunctions.getNodeParameter('operation')).toBe('lookupEvent');
