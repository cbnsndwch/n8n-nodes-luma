...
describe('Node Registration Tests', () => {
    ...
    describe('Ticket Operation Registration', () => {
        it('should register ticket create operation in resource handlers', async () => {
            const { RESOURCE_HANDLERS } = await import(
                '../../dist/nodes/Luma/operations.js'
            );
        ...
        it('should have ticket resource in main node properties', async () => {
            ...
            const ticketResource = resourceProperty?.options?.find(
        ...
        it('should have ticket operations properly configured', async () => {
            ...
            const operationProperty = lumaNode.description.properties.find(
                (p: any) =>
                    p.name === 'operation' &&
            ...
            const operations =
                operationProperty?.options?.map((opt: any) => opt.value) || [];
