...
export class LumaCalendarCouponsTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Luma Calendar Coupons Trigger',
		name: 'lumaCalendarCouponsTrigger',
		icon: 'file:luma.svg',
		group: ['trigger'],
		version: 1,
		subtitle: 'Poll for new calendar coupons',
		description: 'Triggers on new Luma calendar coupons',
		defaults: {
			name: 'Luma Calendar Coupons Trigger',
		},
		inputs: [],
		...
		properties: [
			{
				...
				default: '',
				required: true,
				description: 'The calendar ID to monitor for new coupons',
			},
			{
